...
import Parents from '../images/alandjodee.JPEG'; // Updated path (inside src/)
          ...
          <Col>
            <div className="row">
              <div className="photo-container">
                <img src={Parents} className="familyphoto" alt="Alfred and JoDee Mickelsen" />
              </div>
            </div>
          </Col>
          <Col>
            ...
            <div className="row">
              <div className="team-container">
                ...
                <nav className="nav social-nav pull-center d-none d-lg-inline">
                  <a href="https://twitter.com/mickelsen_s"><i className="fab fa-twitter"></i></a>
                  <a href="https://www.facebook.com/MickelsenFamilyFarms/"><i className="fab fa-facebook"></i></a>
                  <i className="fa fa-envelope"> alandjodee@msn.com</i>
                </nav>
              </div>
            </div>
          </Col>
