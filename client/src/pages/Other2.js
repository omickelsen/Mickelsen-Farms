        ...
        <div>
            ...
            <div className="container">
                <div className='service-container'>
                    <h1 className="service-title">Other 2</h1>
                </div>
            </div>
            <Container>
                <Row>
                                ...
                                <div className="team-container">
                                    ...
                                    <h1>
                                        <nav className="nav social-nav pull-center d-none d-lg-inline">
                                            <a href="https://twitter.com/mickelsen_s"><i className="fab fa-twitter"></i></a><a href="https://www.facebook.com/MickelsenFamilyFarms/"><i className="fab fa-facebook"></i></a> <i className="fa fa-envelope"> Other2@msn.com</i>
                                        </nav>
                                    </h1>
                                </div>
                            </div>
